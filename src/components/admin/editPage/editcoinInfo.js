...
import UpdateCoinAlert from '../../alerts/UpdateCoinAlert/updateCoinAlert'
...
const EditCoinInfo = () => {
    ...
    useEffect( () => {
        ...
        .then(data => {reqFieldsDispatch({ type: "setDefaultVal", payload: data.data})})
    ...
    const setreqFields = ( state, action ) => {
        switch (action.type) {
            case "setDefaultVal":
                ...
                coinAcro: action.payload.coinAcro,

                coinAddressBSC: action.payload.coinAddressBSC,

                coinAddressETH: action.payload.coinAddressETH,
                
                coinAddressTRC: action.payload.coinAddressTRC,

                coinMarketCap: action.payload.coinMarketCap,

                coinPrice: action.payload.coinPrice,

                coinLaunchDate: action.payload.coinLaunchDate,

                coinDescription: action.payload.coinDescription,

                coinLogo: action.payload.coinLogo,

                coinBanner: action.payload.coinBanner,

                coinVote: action.payload.coinVote,

                isReviewed: action.payload.isReviewed,

                isActive: action.payload.isActice,

                isPromoted: action.payload.isPromoted,

                coinTwitter: action.payload.coinTwitter,
                
                coinInstagram: action.payload.coinInstagram,

                coinReddit: action.payload.coinReddit,

                coinTelegram: action.payload.coinTelegram, 
                
                coinWebsite: action.payload.coinWebsite,

                coinYoutube: action.payload.coinYoutube,

                onPanCakeSwap: action.payload.onPanCakeSwap,
        
                onPooCoin: action.payload.onPooCoin,
                
                onBoggedFinance: action.payload.onBoggedFinance,
                
                onCoingecko: action.payload.onCoingecko,
    ...
    const onClickPost = async (e) => {
        e.preventDefault();
            try{
                ...
                await axios.put(`https://coinscore-cc-backend.onrender.com/api/collections/coins/update/${id}`, reqFields);
    ...
    return(
        <div onClick={() => {uiFieldsDispatch({ type: "closePopUp" })}}  className='flex flex-col items-center justify-center'>
                    ...
                    <div className="addCoinBody">
                        ...
                        {uiFields.showPopUp && <UpdateCoinAlert />}
                    </div>
                </div>
