...
const EditCoinSlots = ({coin, deletecoin, deactivatecoin}) => {
 ...
 return (
    ...
    <div className="items-center w-full flex">
        ...
        <div className="items-center  flex">
            ...
            <button onClick={() => deactivatecoin(coin._id)} className="w-8 h-8 rounded-lg contentOuter ml-1 p-1.5">
                <img className='h-full ' src={pause} alt="checkBtn" />
            </button>
