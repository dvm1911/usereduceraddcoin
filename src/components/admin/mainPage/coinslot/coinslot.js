...
const CoinSlots = ({coin, deletecoin, reviewcoin}) => {
 ...
 return (
    ...
    <div className="items-center w-full flex">
        ...
        <div className="items-center  flex">
            ...
            <button onClick={() => reviewcoin(coin._id)} className="w-8 h-8 rounded-lg contentOuter ml-1 p-1.5">
                <img className='h-full ' src={check} alt="checkBtn" />
            </button>
